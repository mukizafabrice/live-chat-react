    ...
    <div className="flex flex-col h-screen bg-gradient-to-r from-purple-600 to-blue-500">
      ...
      <nav className="p-4 bg-white shadow-md bg-opacity-90">
        <div className="flex items-center justify-between mx-auto max-w-7xl">
          <div className="text-3xl font-extrabold tracking-wide text-purple-800">Connectify</div>
          <div>
            <button className="px-6 py-2 text-white transition-colors bg-purple-600 rounded-full hover:bg-purple-700 focus:outline-none">
              Log Out
            </button>
          </div>
        </div>
      ...
      <div className="flex items-center justify-center flex-1">
        <div className="text-center text-white">
          <h1 className="mb-6 text-5xl font-bold leading-tight">Welcome to Connectify</h1>
          <p className="mb-8 text-lg">
            Connect with your friends and start chatting instantly. Stay connected, anytime, anywhere.
          </p>
          <a
            href="/chat"
